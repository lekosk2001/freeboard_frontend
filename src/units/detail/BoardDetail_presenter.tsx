      ...
      <S.ContentsWrapper>
        <S.ContentHead>
          <S.Profile>
            ...
            >
              <path
                d="M24 0.666672C11.12 0.666672 0.666687 11.12 0.666687 24C0.666687 36.88 11.12 47.3333 24 47.3333C36.88 47.3333 47.3334 36.88 47.3334 24C47.3334 11.12 36.88 0.666672 24 0.666672ZM24 7.66667C27.8734 7.66667 31 10.7933 31 14.6667C31 18.54 27.8734 21.6667 24 21.6667C20.1267 21.6667 17 18.54 17 14.6667C17 10.7933 20.1267 7.66667 24 7.66667ZM24 40.8C18.1667 40.8 13.01 37.8133 10 33.2867C10.07 28.6433 19.3334 26.1 24 26.1C28.6434 26.1 37.93 28.6433 38 33.2867C34.99 37.8133 29.8334 40.8 24 40.8Z"
                fill="#BDBDBD"
              />
            </svg>
            <span>
