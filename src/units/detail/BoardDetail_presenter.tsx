        ...
        <C.Main>
            <S.ContentsWrapper>
                ...
                <S.ContentBody>
                    ...
                    {data?.fetchBoard.images&&<S.ImageBox><img src='/image.png'></img></S.ImageBox>}

                    <S.TextBox>
                        {data?.fetchBoard.contents}
                    </S.TextBox>

                    {data?.fetchBoard.youtubeUrl&&<S.YoutubeBox>
                        {/* <PlayButton>
                            <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <C.BottomWrapper>
                ...
                <C.Button onClick={()=>{router.push(`/boards/${data?.fetchBoard._id}/edit`)}}>수정하기</C.Button>
                <C.Button onClick={()=>{onCLickDeleteBoard(data?.fetchBoard ? data?.fetchBoard._id : '')}}>삭제하기</C.Button>
            </C.BottomWrapper>
    </C.Main>
    )
}
